  ...
  return (
    <div className="h-screen w-screen relative text-black dark:text-white overflow-hidden">
      <div className="h-screen w-screen grid grid-cols-12">
        ...
        ></h1>
        <h1
          className={`absolute top-[30%] sm:left-[33.33%] text-2xl md:text-[4vw] lg:text-[2.5vw] !leading-[1] font-extralight sm:font-medium  ${corm.className} h-[60vh] pt-16 pl-[20%] sm:pl-[25%]`}
        >
          Blending
